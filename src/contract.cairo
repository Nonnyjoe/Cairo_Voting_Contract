...
mod Voting_contract {
    ...
    fn participas_registered(
        ref all_participans: Array::<ContractAddress>, no_of_winners: u64, election_no: u64
    ) {}
    ...
    fn Register_Participants(
        ref participants_: Array::<ContractAddress>, no_of_winners: u64, election_no: u64
    ) {
        ...
        let p: Array::<ContractAddress> = participants_;
        ...
        participas_registered(ref participants_, no_of_winners, election_no);
    }
    // #[external]
